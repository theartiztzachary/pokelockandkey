...
#define VAR_CAN_LEAVE_COZMOS_LAB                         0x404E // checks to confirm if players have grabbed both the bag and a starter
#define VAR_LOTAD_SIZE_RECORD                            0x404F
#define VAR_LITTLEROOT_TOWN_STATE                        0x4050
#define VAR_OLDALE_TOWN_STATE                            0x4051
#define VAR_NUMBER_OF_KEYS                               0x4052 // Keeps track of how many 'keys' the player has
#define VAR_LAVARIDGE_TOWN_STATE                         0x4053
#define VAR_CURRENT_SECRET_BASE                          0x4054 // was probably allocated for VAR_FALLARBOR_TOWN_STATE at one point
#define VAR_WORLD_DIFFICULTY                             0x4055 // Keeps track of current world difficulty modifier
