...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_TEAM_AQUA, //1
    TRAINER_CLASS_PKMN_BREEDER, //2
    TRAINER_CLASS_COOLTRAINER, //3
    TRAINER_CLASS_BIRD_KEEPER, //4
    TRAINER_CLASS_COLLECTOR, //5
    TRAINER_CLASS_SWIMMER_M, //6
    TRAINER_CLASS_TEAM_MAGMA, //7
    TRAINER_CLASS_EXPERT, //8
    TRAINER_CLASS_AQUA_ADMIN, //9
    TRAINER_CLASS_BLACK_BELT, //10
    TRAINER_CLASS_AQUA_LEADER, //11
    TRAINER_CLASS_HEX_MANIAC, //12
    TRAINER_CLASS_AROMA_LADY, //13
    TRAINER_CLASS_RUIN_MANIAC, //14
    TRAINER_CLASS_INTERVIEWER, //15
    TRAINER_CLASS_TUBER_F, //16
    TRAINER_CLASS_TUBER_M, //17
    TRAINER_CLASS_LADY, //18
    TRAINER_CLASS_BEAUTY, //19
    TRAINER_CLASS_RICH_BOY, //20
    TRAINER_CLASS_POKEMANIAC, //21
    TRAINER_CLASS_GUITARIST, //22
    TRAINER_CLASS_KINDLER, //23
    TRAINER_CLASS_CAMPER, //24
    TRAINER_CLASS_PICNICKER, //25
    TRAINER_CLASS_BUG_MANIAC, //26
    TRAINER_CLASS_PSYCHIC, //27
    TRAINER_CLASS_GENTLEMAN, //28
    TRAINER_CLASS_ELITE_FOUR, //29
    TRAINER_CLASS_LEADER, //30
    TRAINER_CLASS_SCHOOL_KID, //31
    TRAINER_CLASS_SR_AND_JR, //32
    TRAINER_CLASS_WINSTRATE, //33
    TRAINER_CLASS_POKEFAN, //34
    TRAINER_CLASS_YOUNGSTER, //35
    TRAINER_CLASS_CHAMPION, //36
    TRAINER_CLASS_FISHERMAN, //37
    TRAINER_CLASS_TRIATHLETE, //38
    TRAINER_CLASS_DRAGON_TAMER, //39
    TRAINER_CLASS_NINJA_BOY, //40
    TRAINER_CLASS_BATTLE_GIRL, //41
    TRAINER_CLASS_PARASOL_LADY, //42
    TRAINER_CLASS_SWIMMER_F, //43
    TRAINER_CLASS_TWINS, //44
    TRAINER_CLASS_SAILOR, //45
    TRAINER_CLASS_COOLTRAINER_2, //46 // Used for only one trainer.
    TRAINER_CLASS_MAGMA_ADMIN, //47
    TRAINER_CLASS_RIVAL, //48
    TRAINER_CLASS_BUG_CATCHER, //49
    TRAINER_CLASS_PKMN_RANGER, //50
    TRAINER_CLASS_MAGMA_LEADER, //51
    TRAINER_CLASS_LASS, //52
    TRAINER_CLASS_YOUNG_COUPLE, //53
    TRAINER_CLASS_OLD_COUPLE, //54
    TRAINER_CLASS_SIS_AND_BRO, //55
    TRAINER_CLASS_SALON_MAIDEN, //56
    TRAINER_CLASS_DOME_ACE, //57
    TRAINER_CLASS_PALACE_MAVEN, //58
    TRAINER_CLASS_ARENA_TYCOON, //59
    TRAINER_CLASS_FACTORY_HEAD, //60
    TRAINER_CLASS_PIKE_QUEEN, //61
    TRAINER_CLASS_PYRAMID_KING, //62
    TRAINER_CLASS_RS_PROTAG, //63
    TRAINER_CLASS_COUNT, //64
};
