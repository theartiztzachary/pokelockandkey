...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_HUSTLE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 41, SPECIES_VESPIQUEN, CONDITIONS({IF_GENDER, MON_FEMALE})}),
    },
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_QUEENLY_MAJESTY, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_LIFE_VEST, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_BROWN,
