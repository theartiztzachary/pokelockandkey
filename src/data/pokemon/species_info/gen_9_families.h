...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_FLAME_BODY, ABILITY_BLAZE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_WEAK_ARMOR, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_RED,
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, backYOffset, iconpalette, isTeraform)    \
    ...
    [SPECIES_PECHARUNT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AGONIZING_VENOM, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
