...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_BOUFFALANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RECKLESS, ABILITY_SAP_SIPPER, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_HUSTLE, ABILITY_SHEER_FORCE, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BRAVIARY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DEFIANT, ABILITY_SHEER_FORCE, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BRAVIARY_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_SHEER_FORCE, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Braviary"),
        .cryId = CRY_BRAVIARY,
        .natDexNum = NATIONAL_DEX_BRAVIARY,
