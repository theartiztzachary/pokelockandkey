...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 39, SPECIES_TALONFLAME}),
    },
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_GRASS_PELT, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_INFILTRATOR, ABILITY_PSYCHIC_SURGE },
    ...
    [SPECIES_MEOWSTIC_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRANKSTER, ABILITY_INFILTRATOR, ABILITY_SYNCHRONIZE},
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MEOWSTIC_F] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOUL_HEART, ABILITY_INFILTRATOR, ABILITY_SYNCHRONIZE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Meowstic"),
        .cryId = CRY_MEOWSTIC,
        .natDexNum = NATIONAL_DEX_MEOWSTIC,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_SNIPER, ABILITY_NEUROFORCE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_STURDY, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SLIGGOO, CONDITIONS({IF_NOT_REGION, REGION_HISUI})},
                                {EVO_LEVEL, 40, SPECIES_SLIGGOO_HISUI, CONDITIONS({IF_KNOWS_MOVE_TYPE, TYPE_STEEL})}),
    },
